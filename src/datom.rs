...
use crate::{EntityId, AttributeId, V, TransactionId, Datom as DatomTrait};
...
pub(crate) struct EAVTDatom<'d> { pub datom: Datom<'d> }
...
#[derive(Shrinkwrap, Clone, PartialEq, Eq)]
pub(crate) struct AEVTDatom<'d> { pub datom: Datom<'d> }
